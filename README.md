...
[Step 4] V5.5 Masterpiece HTML 리포트 생성
...
3. **Value Track Top 3** — 벤치마크 대비 저평가율 포함, PBR·ROE 기준 (장기 가치 투자)
4. **Momentum Track Top 3** — 120MA 돌파·수급 호전 종목 (단기 추세)
5. **산업 전망 및 투자 결론** — 수석 애널리스트의 향후 6~12개월 총평 및 전략

리포트는 `[산업명]_master_report_v5.5_{YYMMDD}.html` 형식으로 산업별 폴더에 저장됩니다.
